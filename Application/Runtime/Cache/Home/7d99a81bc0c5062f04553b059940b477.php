...
<link href="/yijvhu/Public/css/smohan.pop&share.css" rel="stylesheet" type="text/css">
...
<div class="wrapper">
  <header>
    ...
    <nav>
      <ul>
        ...
        <li ><a href="<?php echo U('Index/note');?>">留言版</a></li>
      </ul>
    </nav>
  </header>
  <div class="banner">
  ...
  <div class="mainContent">
      <h2 class="title_tj">
         <h1 class="t_nav">
		     <span>您当前的位置：<a href="<?php echo U('Index/index');?>">首页</a>&nbsp;&gt;&nbsp;<?php if($article['p_id']==1) echo "<a href='/yijvhu/index.php/Home/Index/applife'>程序人生</a>"; else if($article['p_id']==2) echo "<a href='/yijvhu/index.php/Home/Index/slowlife'>慢生活</a>"; else echo "<a href='/yijvhu/index.php/Home/Index/sui'>碎言碎语</a>"; ?>
		 </h1>
      </h2>
   
   <div class="index_about">
    <h2 class="c_titile"><?php echo ($article["title"]); ?></h2>
    <p class="box_c"><span class="d_time">发布时间：<?php echo (date("Y-m-d H:i",$article["time"])); ?></span><span>编辑：<a href="<?php echo U('Index/aboutme');?>">方东</a></span></p>
    <ul class="infos">
      <?php echo (str_to($article["content"])); ?>
	  <script type="text/javascript">
 <!--
   var Num=null;
  $(document).ready(function(e) {
    $('a.zhan').click(function(){
	if(Num!=null) {alert('你已经赞过了');return;}
  ...
  $('#zhan').css({'position':'absolute','z-index':'1', 'color':'#C30','left':left+'px','top':top+'px'}).animate({top:top-10,left:left+10},'slow',function(){
   $(this).fadeIn('fast').remove();
    Num = parseInt(obj.find('span').text());
       Num++; 
$.get('/yijvhu/index.php/Home/Index/addzan',  
...
<br>
<a class="zhan" style="background:rgb(157, 197, 219);display:block;width:100px;margin: 30px auto 0 auto;" href="#zhan">赞(<span><?php echo ($article["zan"]); ?></span>)</a>
<a href="javascript:void(0)" class="share" style=" width:100px;background: rgb(231, 200, 200);display: block;margin: 18px auto 0 auto;">分享</a>
<script type="text/javascript" src="/yijvhu/Public/js/smohan.pop&share.js"></script>
	 </ul>
</div>
