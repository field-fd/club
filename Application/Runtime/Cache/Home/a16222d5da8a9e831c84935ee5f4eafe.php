...
<div class="main"> 
  <div class="content" style="float:right;border:1px solid #ccc;background: white;"><!--xinjia beijingyanse-->
    <div class="content-head" style="height: 25px;background-image:url(/yijvhu/Public/images/modelhead.png);"><span class="addblog">全部留言</span></div>
    <div class="content-body">
      ...
      <div class="content11" style="background: white;padding-top:20px;">
		...
		<span><?php echo (date("Y-m-d H:i",$vo["time"])); ?></span>&nbsp&nbsp&nbsp&nbsp<a   href="javascript:myClick('/yijvhu/index.php/Home/Login/drop/id/<?php echo ($vo["id"]); ?>')">&nbsp&nbsp删除</a> 
		</span>
