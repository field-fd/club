...
<div class="wrapper">
  <header>
    ...
    <nav>
      <ul>
        ...
        <li id="active"><a href="<?php echo U('Index/slowlife');?>">慢生活</a></li>
  ...
  <div class="mainContent">
    <h2 class="title_tj">
      <h1 class="t_nav">
		     <span>您当前的位置：<a href="<?php echo U('Index/index');?>">首页</a>&nbsp;>&nbsp;<a href="<?php echo U('Index/slowlife');?>">慢生活</a></span>
	 </h1>
    </h2>
    <div class="bloglist">
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><h3><a href="/yijvhu/index.php/Home/Index/article/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></h3>
      <ul>
        </p><?php $content=strlen($vo['content']); if($content>40)echo mb_substr($vo['content'],0,100,'utf-8')."..." ;else echo $vo['content']; ?></p>
      </ul>
      <div class="dateview"><a title="/" href="/yijvhu/index.php/Home/Index/article/id/<?php echo ($vo["id"]); ?>" target="_blank" class="readmore">阅读全文>></a>
	  <span><?php echo (date("Y-m-d",$vo["time"])); ?> 赞(<?php echo ($vo["zan"]); ?>)</span><span>作者：方东</span>
	  <span>个人博客：[<a href="<?php echo U('Index/slowlife');?>">慢生活</a>]</span>
