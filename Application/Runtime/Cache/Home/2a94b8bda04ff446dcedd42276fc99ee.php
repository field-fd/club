...
<script type="text/javascript">
   ...
   $(document).ready(function() {
     $.ajax({
                url:"<?php echo U('Index/getArticle');?>",
                type:'POST',
                success:function(data) {   
                   $("#getArticle").append(data[0].title+'<br>'+data[0].content+'<br>'+data[0].time);
...
<div class="wap-top" >
    ...
    <a href="http://www.wickedread.cn"><img class="navbar-home" src="/yijvhu/Public/images/home.png"></a>
</div>
<div class="wrapper">
  <header>
    <h1 id="logo"><a href="<?php echo U('Index/index');?>"><img src="/yijvhu/Public/images/logo.png" width="260" height="60" alt="方东个人博客"></a></h1>
    <nav>
      <ul>
        <li id="active"><a href="<?php echo U('Index/index');?>">网站首页</a></li>
