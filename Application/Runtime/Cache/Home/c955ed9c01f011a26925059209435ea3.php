...
<div class="wrapper">
  <header>
    ...
    <nav>
      <ul>
        ...
        <li id="active"><a href="<?php echo U('Index/sui');?>">碎言碎语</a></li>
  ...
  <div class="mainContent">
    <h2 class="title_tj">
      <h1 class="t_nav">
		     <span>您当前的位置：<a href="<?php echo U('Index/index');?>">首页</a>&nbsp;>&nbsp;<a href="<?php echo U('Index/sui');?>">碎言碎语</a></span>
	 </h1>
    </h2>
    <div class="bloglist">
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><h3><a href="/yijvhu/index.php/Home/Index/article/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></h3>
	  ...
	  <span>个人博客：[<php><a href="<?php echo U('Index/sui');?>">碎言碎语</a>]</span>
