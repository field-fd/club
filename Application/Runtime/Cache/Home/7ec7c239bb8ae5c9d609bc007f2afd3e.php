...
<div class="wrapper">
  <header>
    ...
    <nav>
      <ul>
        ...
        <li id="active"><a href="<?php echo U('Index/aboutme');?>">关于我</a></li>
  ...
  <div class="banner">
    <div class="headerPic"><a href="/"><span>方东个人博客</span></a></div>
  ...
  <div class="mainContent">
      <h2 class="title_tj">
         <h1 class="t_nav">
		     <span>您当前的位置：<a href="<?php echo U('Index/index');?>">首页</a>&nbsp;>&nbsp;<a href="<?php echo U('Index/aboutme');?>">关于我</a></span>
		 </h1>
      </h2>
      <div class="aboutme">
        <p>方东，男，一个90后学生！就读于鲁东大学信电学院计算机专业。14年开始接触网站建设，性格开朗、稳重、有活力，待人热情、真诚。一直是单身狗。</p>

<p>人生就是一个得与失的过程，而我却是一个幸运者，失去的永远比得到的多。高考的不如意，让我没考上如愿的电子、机械专业，换来虽有些蓬头垢面的计算机专业，但是我仍然很享受那些熬得只剩下黑眼圈的日子，因为我在学习使用HTML、css、javascript、jquery、PHP...中激发了兴趣，然后越走越远....</p>

<p>在这条路上，我最要感谢的一个人是学生网的王奉新（王杰）学长，是他给了我学习的动力，他让我人生有了目标，我觉得他是我的伯乐，因为我当初什么都不会，但是他却给了我机会，而我就牢牢的把握了那次机会……</p>
 <p>联系方式:</p>
 <p><a target="_blank" href="http://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=375373223@qq.com" ><img src="http://rescdn.qqmail.com/zh_CN/htmledition/images/function/qm_open/ico_mailme_22.png" alt="方东个人博客网站"></a></p>
  <p>qq：375373223</p> 
       </div>
  </div>
 <div class="sidebar">
