...
<div id="slick-login" style="margin:80px auto;width:350px;">
    <a href="/club/index.php/Admin/Club/index">主页</a> <br>
       ...
       <a href="/club/index.php/Admin/Club/pass/club_id/<?php echo ($club["id"]); ?>">通过</a>  
       <a href="/club/index.php/Admin/Club/reject/club_id/<?php echo ($club["id"]); ?>">驳回</a>   
       <a href="/club/index.php/Admin/Club/delete/club_id/<?php echo ($club["id"]); ?>">删除</a>     
</div>
</body>
</html>